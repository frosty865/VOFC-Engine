...
print("FINAL CSV IMPORT: Using Correct Data")
print("=" * 50)
...
with open(sources_file, 'r', encoding='utf-8') as f:
    ...
    for row in reader:
        ...
        source_data = {
            "id": new_id,
            "reference_number": row['id'],  # Use original ID as reference number
...
print("\nUsing correct CSV data with proper schema!")
