...
print("GOING LIVE: SAFE VOFC Library Import")
print("=" * 50)
...
# ---------- STEP 2: Parse the PDF with production-ready logic ----------
print("Parsing SAFE VOFC Library PDF...")
        ...
        if "The facility" in line:
            ...
            if len(parts) > 1:
                ...
                while i < len(lines):
                    ...
                    # Check if this is an OFC (starts with action words or ends with citation)
                    is_ofc = (
...
for ofc in ofcs.data[:10]:  # Link sources to first 10 OFCs
...
print("\nPRODUCTION DATA STRUCTURE COMPLETE!")
print("=" * 50)
