    ...
    while i < len(lines):
        ...
        if line.startswith("The facility"):
            ...
            while i < len(lines):
                ...
                # Check if this is an OFC (starts with bullet, number, or has citation)
        ...
        # Look for OFCs (bullet points, numbered items, or items with citations)
...
# Write results
with open("simple_safe_vofc_library.json", "w", encoding="utf-8") as f:
