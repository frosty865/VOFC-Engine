...
print("TABLE STRUCTURE PARSER: 3-Column Format")
print("=" * 50)
...
# ---------- STEP 2: Parse the PDF as a 3-column table ----------
print("Parsing PDF as 3-column table...")
...
for page_num, page in enumerate(reader.pages):
    ...
    while i < len(lines):
        ...
        # Skip table headers
        if "Category" in line and "Vulnerability" in line and "Options for Consideration" in line:
            i += 1
            continue
        
        # Look for the pattern: Category | Vulnerability | Options
        # The structure is usually:
        # Line 1: Category
        # Line 2: Vulnerability (starts with "The facility")
        # Line 3+: Options for Consideration (with citations)
        
        if "The facility" in line:
            # This is a vulnerability row
            ...
            if len(parts) > 1:
                ...
                # Continue collecting vulnerability text and OFCs
                while i < len(lines):
                    next_line = lines[i]
                    
                    # Check if this is an OFC (contains citations or action words)
                    is_ofc = (
                        re.search(r'\d{2,3}\s*$', next_line) or  # Ends with citation number
                    ...
                    if is_ofc:
                        ...
                        ofc_text = re.sub(r'^[•\-*]\s*', '', next_line)  # Remove bullets
...
print("\nTABLE STRUCTURE PARSER COMPLETE!")
print("=" * 50)
...
print("\n3-column table structure properly parsed!")
