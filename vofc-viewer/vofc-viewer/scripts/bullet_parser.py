...
print("BULLET PARSER: Each bullet = One OFC")
print("=" * 50)
...
# Parse PDF - each bullet point is a separate OFC
print("Parsing PDF - each bullet point is an OFC...")
            ...
            if len(parts) > 1:
                ...
                while i < len(lines):
                    ...
                    if is_bullet:
                        ...
                        ofc_text = re.sub(r'^[•◦▪▫‣⁃⁌⁍⁎⁏⁐⁑⁒⁓⁔⁕⁖⁗⁘⁙⁚⁛⁜⁝⁞\-*]\s*', '', next_line)
